  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['y-mehta/ssrf-req-filter', 'y-mehta/vulnalerts','DedSecInside/TorBot'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
